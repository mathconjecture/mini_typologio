...
\usepackage{geometry}
\geometry{a4paper,top=5mm,bottom=5mm,left=5mm,right=5mm}
...
% Section
\titleformat{\chapter}[hang]{\pagestyle{plain}\large\bfseries\centering}{\begin{tcolorbox}[colback=Col\thechapter,left=1pt,right=1pt,top=1pt,bottom=1pt,sharp
corners,boxrule=0pt]\centering\strut\textcolor{white}{#1}\end{tcolorbox}}{0ex}{}[]
\titlespacing*{\chapter}{0cm}{0ex}{0\baselineskip}[0ex]

% Section
\titleformat{\section}[hang]{\pagestyle{plain}\bfseries\centering}{\begin{tcolorbox}[colback=Col\thechapter!75,left=1pt,right=1pt,top=1pt,bottom=1pt,sharp
corners,boxrule=0pt]\centering\strut\textcolor{white}{#1}\end{tcolorbox}}{0ex}{}[]
\titlespacing*{\section}{0cm}{0ex}{0ex}[0ex]

% subsection
\titleformat{\subsection}[hang]{\pagestyle{plain}\normalsize\bfseries\centering}{\begin{tcolorbox}[colback=Col\thechapter!50!white,left=1pt,right=1pt,top=1pt,bottom=1pt,sharp
corners,boxrule=0pt]\centering\strut\textcolor{white}{#1}\end{tcolorbox}}{0ex}{}
...
%%%%%%%%%%%%%%%% WATERMARK above pictures with opacity %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 \usepackage[printwatermark]{xwatermark}
 \newsavebox\mybox
 \savebox\mybox{\tikz[color=Col2!40,opacity=0.4]\node{ΠΡΟΣΗΜΟ};}
 \newwatermark*[
   allpages,
   angle=45,
   scale=12,
